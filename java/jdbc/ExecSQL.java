...
public class ExecSQL {
  ...
  public static Connection getConnection () throws SQLException, IOException  {
    ...
    try (InputStream in = Files.newInputStream(Paths.get("/home/niraj/mega/edu/tu-courses/bca/advanced_java/corejava/app/src/main/java/database.properties")))
    {
      props.load(in);
    }
